...
\textit{Feature importance of input parameters obtained with the random forest surrogate.}
...
% Pareto front of proportion of sick vs. vaccination rate.

\includegraphics[width=0.49\linewidth]{../figures/pareto2.png}
% Pareto front of proportion of sick vs. social distancing levels.
